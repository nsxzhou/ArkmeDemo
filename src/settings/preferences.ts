...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "arrangements.editorDesc": "提醒仅保存展示，暂不触发系统通知。",
    ...
    "arrangements.reminderNote": "V1 只保存提醒配置，不触发通知。",
  ...
  "zh-TW": {
    ...
    "arrangements.editorDesc": "提醒僅保存展示，暫不觸發系統通知。",
    ...
    "arrangements.reminderNote": "V1 只保存提醒配置，不觸發通知。",
    "arrangements.reminderDisplayOnly": "未配置提醒",
  ...
  "en-US": {
    ...
    "arrangements.editorDesc": "Reminders are saved for display only and do not trigger notifications yet.",
    ...
    "arrangements.reminderNote": "V1 only saves reminder settings. It does not send notifications.",
